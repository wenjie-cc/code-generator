package ${packageName}<#if moduleName??>.${moduleName}</#if>.controller.web;
...
/**
 * ${tableInfo.tableRemarks?if_exists}WEB控制层
 *
 * @author: ${author}
 * @date: ${date}
 */
@Tag(name = "Web-${tableInfo.tableRemarks?if_exists}", description = "${tableInfo.tableRemarks?if_exists}Web接口")
@RestController
@RequestMapping("/web/${camelConvert(tableInfo.tableClassName, "-")}")
@RequiredArgsConstructor
public class ${tableInfo.tableClassName}WebController {
