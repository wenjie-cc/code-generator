...
/**
 * ${tableInfo.tableRemarks?if_exists}-请求对象-新增
 *
 * @author: ${author}
 * @date: ${date}
 */
@Data
@Schema(description = "${tableInfo.tableRemarks?if_exists}-请求对象-新增")
public class ${tableInfo.tableClassName}CreateDTO implements Serializable {
